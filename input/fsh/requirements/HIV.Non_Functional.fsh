...
* statement[+]
  * key = "HIV.NFXNREQ.016"
  * requirement = """
    For Security - audit trail and logs ,
...
* statement[+]
  * key = "HIV.NFXNREQ.033"
  * requirement = """
    For System requirements - general ,
...
* statement[+]
  * key = "HIV.NFXNREQ.045"
  * requirement = """
    For System requirements - scalability ,
...
* statement[+]
  * key = "HIV.NFXNREQ.048"
  * requirement = """
    For System requirements - usability ,
...
* statement[+]
  * key = "HIV.NFXNREQ.059"
  * requirement = """
    For System requirements - configuration ,
...
* statement[+]
  * key = "HIV.NFXNREQ.063"
  * requirement = """
    For System requirements - interoperability ,
...
* statement[+]
  * key = "HIV.NFXNREQ.069"
  * requirement = """
    For System requirements - hardware and connectivity ,
